...
/****************************************************************************/
        ...
        char* cmd = (char*)malloc(hotfix_strlen("rm -rf ")+hotfix_strlen(task.obj_path)+hotfix_strlen("/*.o")+1+hotfix_strlen(task.output_path)+1+hotfix_strlen(ccc_file_name)+1);
        memset(cmd,0,hotfix_strlen("rm -rf ")+hotfix_strlen(task.obj_path)+hotfix_strlen("/*.o")+1+hotfix_strlen(task.output_path)+1+hotfix_strlen(ccc_file_name)+1);
